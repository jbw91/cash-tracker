...
.run(function($ionicPlatform, $cordovaSQLite, $rootScope, $cordovaStatusbar, Categories, Transactions, $http, $cordovaAppVersion, $cordovaDevice) {
	$ionicPlatform.ready(function() {
		...
		$rootScope.device = $cordovaDevice.getPlatform();
